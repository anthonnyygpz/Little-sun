...
import { fetchByNameClient, createClient, fetchClient, deleteClient, updateClient } from "../api/enpoints/clientApi";
...
const useClients = () => {
  ...
  return { clients, clientAll, loading, loadingClientAll, error, errorClientAll, getByNameClient, addClient, getAll, deleteClients, updateClients };
};
